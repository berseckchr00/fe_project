...
public class RESPUESTADocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.xmlSchema.RESPUESTADocument
{
    ...
    public static class RESPUESTAImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.xmlSchema.RESPUESTADocument.RESPUESTA
    {
        ...
        public static class RESPBODYImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cl.sii.xmlSchema.RESPUESTADocument.RESPUESTA.RESPBODY
        {
            ...
            private static final javax.xml.namespace.QName TIPO_DOCTO$2 = 
                    new javax.xml.namespace.QName("http://www.sii.cl/XMLSchema", "TIPO_DOCTO");
            private static final javax.xml.namespace.QName RECHAZADOS$2 = 
                    new javax.xml.namespace.QName("http://www.sii.cl/XMLSchema", "RECHAZADOS");
            private static final javax.xml.namespace.QName REPAROS$2 = 
                    new javax.xml.namespace.QName("http://www.sii.cl/XMLSchema", "REPAROS");
			...
			public String getTIPO_DOCTO() {
                synchronized (monitor())
                {
                    check_orphaned();
                    org.apache.xmlbeans.SimpleValue target = null;
                    target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(TIPO_DOCTO$2, 0);
                    if (target == null)
                    {
                      return null;
                    }
			...
			public String getRECHAZADOS() {
                synchronized (monitor())
                {
                    check_orphaned();
                    org.apache.xmlbeans.SimpleValue target = null;
                    target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(RECHAZADOS$2, 0);
                    if (target == null)
                    {
                      return null;
                    }
			...
			public String getREPAROS() {
                synchronized (monitor())
                {
                    check_orphaned();
                    org.apache.xmlbeans.SimpleValue target = null;
                    target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(REPAROS$2, 0);
                    if (target == null)
                    {
                      return null;
                    }
